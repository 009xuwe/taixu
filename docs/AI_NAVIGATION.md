...
| **RikkaHub 对标分析与 Harness 演进规划** | [`docs/RIKKAHUB_BORROWING_ANALYSIS.md`](RIKKAHUB_BORROWING_ANALYSIS.md) | 分级容错编辑 TextReplacers、Claude 4 缓存断点与 pause_turn 续流、沙箱图片视觉直通、流式重试快照 |
